...
const products = productRows.map((row, index) => {
  ...
  return {
    ...
    badge: row[7],
    accent: row[8],
    description: `${row[1]} disponível no catálogo da ${platformConfig.storeName}. Consulte os detalhes e finalize seu pedido pelo WhatsApp.`,
...
export const seedData: StoreData = {
  ...
  settings: {
    ...
    promotionName: "Campanha da semana",
    promotionStartsAt: "",
    promotionEndsAt: "",
    promotionHighlights: [],
    promotionGiftMessage: "",
    promotionPriceMatchMessage: "",
    pixDiscount: 5,
    pixDiscountMinimum: 0,
    cardInstallments: 2,
    cardInstallmentMinimum: 0,
  ...
  banners: [
    {
      ...
      subtitle: "Explore o catálogo, aplique o cupom e finalize seu pedido em poucos passos.",
    ...
    },
    {
      ...
      subtitle: "Aproveite a condição especial na sua primeira compra.",
  ...
  trustItems: [
    ...
    { id: "trust-2", title: "Pagamento confirmado", subtitle: "Condições informadas no WhatsApp", order: 2 },
    { id: "trust-3", title: "Envio acompanhado", subtitle: "Atualizações pelo atendimento", order: 3 },
  ...
  sections: [
    ...
    { id: "section-faq", kind: "faq", name: "Como comprar", eyebrow: "PERGUNTAS FREQUENTES", title: "Como comprar na loja.", subtitle: "", active: true, order: 5 },
  ],
  pages: [
  ...
  benefits: [
    ...
    { id: "benefit-3", title: "Checkout objetivo", text: "Formulário simples com entrega e pagamento confirmados no atendimento.", order: 3 },
    { id: "benefit-4", title: "Gestão centralizada", text: "Catálogo, conteúdo e pedidos disponíveis no painel.", order: 4 },
  ],
  faqs: [
    { id: "faq-1", question: "Como faço uma compra?", answer: "Escolha os produtos, adicione ao carrinho e preencha o checkout. Ao finalizar, o WhatsApp abrirá com os dados do pedido para a equipe continuar o atendimento.", order: 1 },
    { id: "faq-2", question: "Como será feito o pagamento?", answer: "No checkout você informa a forma de pagamento preferida. A equipe confirma pelo WhatsApp o valor e as instruções para pagamento.", order: 2 },
    { id: "faq-3", question: "Quando meu pedido será enviado?", answer: "O envio é organizado depois da confirmação do pedido e do pagamento, com atualizações pelo WhatsApp.", order: 3 },
    { id: "faq-4", question: "Como funciona a garantia?", answer: "É obrigatório gravar um vídeo sem cortes abrindo a encomenda, começando pela caixa lacrada e mostrando os produtos. Sem esse vídeo, não há garantia, troca ou reenvio.", order: 4 },
    { id: "faq-5", question: "Posso tirar dúvidas antes de comprar?", answer: "Sim. Use o botão do WhatsApp para falar com a equipe antes de finalizar o pedido.", order: 5 },
  ],
  coupons: [
    { 
      id: "coupon-1", 
