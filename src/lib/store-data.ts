...
function mapSettings(row: Row, fallback: StoreSettings): StoreSettings {
  return {
    ...
    promotionEnabled: row.promotion_enabled === undefined ? fallback.promotionEnabled : Boolean(row.promotion_enabled),
    promotionName: str(row.promotion_name) || fallback.promotionName,
    ...
    cardInstallmentMinimum: row.card_installment_minimum === undefined ? fallback.cardInstallmentMinimum : num(row.card_installment_minimum),
    loyaltyDiscountEnabled: row.loyalty_discount_enabled === undefined ? fallback.loyaltyDiscountEnabled : Boolean(row.loyalty_discount_enabled),
    loyaltyOrderInterval: row.loyalty_order_interval === undefined ? fallback.loyaltyOrderInterval : num(row.loyalty_order_interval),
    loyaltyDiscountAmount: row.loyalty_discount_amount === undefined ? fallback.loyaltyDiscountAmount : num(row.loyalty_discount_amount),
