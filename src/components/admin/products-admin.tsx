...
export function ProductsAdmin() {
  ...
  return (
    <>
      <AdminPanel title="Produtos" description="Pesquise, filtre, edite, oculte e defina a ordem de exibição." action={<div className="admin-panel-actions"><Link className="admin-button" href="/admin/import"><FileSpreadsheet /> Importar planilha</Link><Link className="admin-button primary" href="/admin/products/new"><Plus /><span>Adicionar produto</span></Link></div>}>
