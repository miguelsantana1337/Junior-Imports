        ...
        {visibleProducts.length ? (
          <>
            ...
            <div className="admin-mobile-cards admin-products-mobile-list">{visibleProducts.map((product) => <article className="admin-product-mobile-card" key={product.id}>
              ...
              <div className="admin-product-mobile-details"><span><b>{product.madeToOrder ? "Sob encomenda" : product.stock}</b>{product.madeToOrder ? "" : " em estoque"}</span><span>{product.category}</span></div>
