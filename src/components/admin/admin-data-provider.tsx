...
export function AdminDataProvider({ initialData, currentUser, referenceNow, children }: { initialData: StoreData; currentUser: AdminDataContextValue["currentUser"]; referenceNow: number; children: ReactNode }) {
  ...
  const saveSettings = useCallback(async (settings: StoreSettings) => {
    await commitMutation(
      ...
      () => persist("store_settings", { id: "default", operation_started_at: settings.operationStartedAt || null, store_name: settings.storeName, logo_url: settings.logoUrl, mobile_logo_url: settings.mobileLogoUrl, favicon_url: settings.faviconUrl, whatsapp: settings.whatsapp, order_prefix: settings.orderPrefix, email: settings.email, hours: settings.hours, announcement: settings.announcement, footer_description: settings.footerDescription, primary_color: settings.primaryColor, secondary_color: settings.secondaryColor, background_color: settings.backgroundColor, text_color: settings.textColor, font_family: settings.fontFamily, header_layout: settings.headerLayout, content_width: settings.contentWidth, border_radius: settings.borderRadius, free_shipping_threshold: settings.freeShippingThreshold, shipping_flat: settings.shippingFlat, shipping_city_rates: settings.shippingCityRates, quote_shipping_outside_cities: settings.quoteShippingOutsideCities, local_pickup_enabled: settings.localPickupEnabled, local_pickup_instructions: settings.localPickupInstructions, free_shipping_enabled: settings.freeShippingEnabled, free_shipping_banner_enabled: settings.freeShippingBannerEnabled, free_shipping_banner_eyebrow: settings.freeShippingBannerEyebrow, free_shipping_banner_title: settings.freeShippingBannerTitle, free_shipping_banner_subtitle: settings.freeShippingBannerSubtitle, free_shipping_banner_button_text: settings.freeShippingBannerButtonText, free_shipping_banner_button_link: settings.freeShippingBannerButtonLink, promotion_enabled: settings.promotionEnabled, promotion_name: settings.promotionName, promotion_starts_at: settings.promotionStartsAt || null, promotion_ends_at: settings.promotionEndsAt || null, promotion_highlights: settings.promotionHighlights, promotion_gift_message: settings.promotionGiftMessage, promotion_price_match_message: settings.promotionPriceMatchMessage, quantity_promotion: settings.quantityPromotion, pix_discount: settings.pixDiscount, pix_discount_minimum: settings.pixDiscountMinimum, card_installments: settings.cardInstallments, card_installment_minimum: settings.cardInstallmentMinimum, loyalty_discount_enabled: settings.loyaltyDiscountEnabled, loyalty_order_interval: settings.loyaltyOrderInterval, loyalty_discount_amount: settings.loyaltyDiscountAmount, auto_banner_seconds: settings.autoBannerSeconds, checkout_mode: settings.checkoutMode, whatsapp_message: settings.whatsappMessage }),
